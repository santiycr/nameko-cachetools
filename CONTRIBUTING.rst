...
Ready to contribute? Here's how to set up `nameko-cachetools` for
local development.

1. Fork_ the `nameko-cachetools` repo on GitHub.
...
3. The pull request should work for Python 2.7, and 3.3, and for PyPy.
...
To run a subset of tests::
	 ...
	 $ py.test test/test_nameko-cachetools.py
